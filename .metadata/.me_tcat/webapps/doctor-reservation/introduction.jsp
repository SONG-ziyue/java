...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="height: 350px; width: 629px; ">
<iframe src="top2.jsp" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="60%" scrolling="no"></iframe>

<table width="70%" border="0" cellpadding="0" cellspacing="0" class="main" style="width: 921px; ">
<tr valign="top">

</tr>
</table>
<td ><form action="DoctorAction?method=select" method="post" name="form1" onSubmit="return checkuser()">
  <table width="90%" border="0" cellpadding="2" cellspacing="1" class="inputTable">
    <tr>
          <td align="center"  ">
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="inputbox"; ">
	   <tr>
            <th width="15%" align="center" class="inputHeader">教师姓名：</th> 
          ...
          <tr>
            <th width="15%" align="center" class="inputHeader">院系：</th>
            <td width="20%" align="left" class="inputContent">${map.type}</td> 
             <th width="15%" align="center" class="inputHeader">TEL：</th>
           ...
           <td width="20%" align="left" class="inputContent"></td>                
            ...
            <th width="15%" align="center" class="inputHeader">研究方向：</th>
