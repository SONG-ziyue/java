...
<td><form action="DoctorAction?method=select" method="post" name="form1" onSubmit="return checkuser()">
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="inputTable">
    <tr>
      ...
      <td align="center"><font color="grey">(请输入教师姓名或者院系)</font>
      <input   type="text" name="infor"/>
      <input type="submit" value="点击查询">&nbsp;&nbsp;&nbsp;
      <a href="DoctorAction?method=allDoctor">全部教师信息</a>
      </td>
    </tr>
    ...
    <tr>
      <td class="inputHeader">
	   <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="inputbox">
          <tr>
            <td width="15%" align="center" class="inputHeader">教师姓名</td>
            <td width="15%" align="center" class="inputContent">院系</td>
           <td width="15%" align="center" class="inputContent">研究方向</td>
