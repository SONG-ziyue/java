...
<table width="100%" border="1" cellpadding="1" cellspacing="1" class="yrh">
  <tr>
    <td height="17"><font size="3" >学生预约列表</font></td>
  </tr>
</table>
...
<tr>
            ...
            <td width="13%" align="center" class="inputHeader">教师姓名</td>
            <td width="13%" align="center" class="inputHeader">学生姓名</td>
            <td width="22%" align="center" class="inputHeader">院系</td>
  <td width="22%" align="center" class="inputHeader">时间</td>
   ...
   <td width="22%" align="center" class="inputHeader">${list.time}</td>
           ...
           <a href="OrderAction?method=deleteOrder&id=${list.id}" 
           onClick="window.confirm('确定删除？')">
           <img src="picture/delete_item.gif" alt="删除" width="45" height="17" border="0">
           </a></p></td>
