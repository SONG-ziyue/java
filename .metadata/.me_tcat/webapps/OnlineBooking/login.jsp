...
<body>
	<div class="container">
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div
						...
						<a href="#"
							onclick="$('#signupbox').hide(); $('#forgetpasswordbox').show();$('#loginbox').hide()">Forgot
							password?</a>
					</div>
				</div>
					...
					<form action="login" method="post" id="loginform"
							...
							<div class="col-md-6">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-envelope-o fa-fw"></i></span> <input id="email"
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-key fa-fw"></i></span> <input id="password"
							...
							<div class="col-md-12 control">
								<div
									...
									Don't have an account? <a href="#"
										onClick="$('#loginbox').hide();$('#forgetpasswordbox').hide(); $('#signupbox').show()">Sign
										Up Here</a>
								</div>
							</div>
						</div>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div
						...
						<a id="signinlink"
							onclick="$('#signupbox').hide(); $('#forgetpasswordbox').hide();$('#loginbox').show()">Sign
							In</a>
					</div>
				</div>
		...
		<div id="forgetpasswordbox" style="display: none; margin-top: 50px"
			class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
			<div class="panel panel-info">
				<div class="panel-heading">
				...
				<div class="panel-body">
					<form action="forgotPassword" method="post" id="forgotPasswordForm"
						class="form-horizontal" role="form"
						onSubmit="return checkForm('forgotPasswordEmail')">
						<div class="form-group">
							<label class="col-md-3 control-label" for="email">Email</label>
							<div class="col-md-6">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										id="forgotPasswordEmail" name="forgotPasswordEmail"
										type="text" placeholder="Enter Your Email"
										class="form-control input-md"
										onblur="checkForm('forgotPasswordEmail')">
								</div>
							</div>
							<div class="col-md-3">
								<input id="btn-sendEmail" type="submit" class="btn btn-success"
									value="Send Email" />
							</div>
						</div>
						<div class="form-group">
