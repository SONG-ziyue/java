...
<table width="100%" border="1" cellpadding="1" cellspacing="1" class="yrh">
  <tr>
    <td height="17"><font size="3" color="#CC0000">现有学生列表</font></td>
  </tr>
</table>
...
<tr>
        ...
        <tr>
            ...
            <td width="22%" align="center" class="inputHeader">${list.truename}</td>
   <td width="22%" align="center" class="inputHeader">${list.phone}</td>
    <td width="22%" align="center" class="inputHeader">${list.address}</td>
             ...
             <a href="UserAction?method=deleteUser&id=${list.id}" onClick="window.confirm('确定删除？')"><img src="picture/delete_item.gif" alt="删除" width="45" height="17" border="0"></a></p></td>
