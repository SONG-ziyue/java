...
<iframe src="top.jsp" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="50%" scrolling="no"></iframe>
      ...
      <td class="inputHeader">
	   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="inputbox">
          <tr>
            ...
            <input type="Text" class="text width100" name="username" onFocus="nextfield='name'" value="" maxlength="25"></td>
          ...
          <tr>
            ...
            <td align="center" class="inputHeader">密码：</td>
            <td align="center" class="inputContent">
            <input type="password" class="text width100" name="password"  maxlength="25"></td>
            <td align="center" class="inputContent">&nbsp;</td>
            <td align="center" class="inputContent">&nbsp;</td>
          </tr>
          <tr>
