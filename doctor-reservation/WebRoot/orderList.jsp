    ...
    <tr>
      <td class="inputHeader">
	   <table width="100%" border="0" cellpadding="0" cellspacing="1" class="inputbox">
          <tr>
            <td width="25%" align="center" class="inputHeader">教师姓名</td>
            <td width="23%" align="center" class="inputContent">院系</td>
          ...
          <c:forEach items="${list}" var="list">
            ...
            <td width="10%" align="center" class="inputContent">
            <a href="OrderAction?method=cancel&id=${list.id}">取消</a></td>        
          </tr>  
          </c:forEach>
        </table>
